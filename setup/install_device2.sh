...
VENV_PATH="${HOME_DIR}/venv_device2"
...
chown -R "${CURRENT_USER}:${CURRENT_USER}" "${HOME_DIR}/data" "${HOME_DIR}/logs" "${HOME_DIR}/config" 2>/dev/null || true
...
echo ""
echo "4. (Valgfrit) Opsæt kiosk-tilstand på tilsluttet touchskærm:"
echo "   bash setup/setup_kiosk.sh"
echo "   Åbner automatisk dashboardet i Chromium ved login."
echo ""
